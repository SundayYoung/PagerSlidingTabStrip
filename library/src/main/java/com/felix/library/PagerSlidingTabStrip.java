...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int maxIndicatorLineWidth;
    ...
    private boolean tabSelectedBold = false;

    private int lastScrollX = 0;

    private int tabBackgroundResId = R.drawable.item_background_borderless;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        maxIndicatorLineWidth = a.getDimensionPixelSize(R.styleable.PagerSlidingTabStrip_pstsMaxIndicatorLineWidth, 0);
